...
const { raunyfb } = require('./dark/bash/raunyfb')
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Rauny\n' // Nama kamu
            + 'ORG:Sadzin;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5514998360726:+55 1499836-0726\n' //Nomor whatsapp kamu
            + 'END:VCARD'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD SADZIN BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de Rauny. Registre-se para fazer amizade com o bot Sadzin por meio, \n\nCommand : ${prefixbotbot}daftar nama|idade\nExemplo : ${prefixbotbot}daftar Rauny|15\n\n──「 Sadzin BOT 」──`,
					admin: '[❗] Este comando só pode ser usado por administradores de grupo! ❌',
					Badmin: ' [❗] Este comando só pode ser usado quando o bot se torna administrador! ❌',
				}
			}

			const botNumber = sadzin.user.jid
			const ownerNumber = ["5514998360726@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5514998360726@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5514998360726@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5514998360726@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5514998360726@s.whatsapp.net","554799056517@s.whatsapp.net","5514998873386@s.whatsapp.net","553399693281@s.whatsapp.net","559288134265@s.whatsapp.net"]
...
//msc fim
			...
			dark.updatePresence(from, Presence.composing)
			data = fs.readFileSync('./src/raunyjokes.js');
		...
		case 'halloweentext':
		    ...
		    break
                ...
                case 'tratag':
                    ...
                    dark.sendMess('5514998360726@s.whatsapp.net', options, text, {quoted: mek})
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO Sadzin Bot 👑* 」\n\`\`\``
					no = 0
